...
export function Navbar({ variant = "landing", user }: NavbarProps) {
  ...
  const navigationData = {
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              description: "Native Android mobile solutions",
            },
            {
      ...
      sections: [
          ...
          items: [
            {
              name: "Our Story",
              href: "/about#story",
              description: "How Techlogies came to be",
            },
            {
              name: "Mission & Vision",
              href: "/about#mission",
        ...
        },
        {
          ...
          items: [
            ...
            {
              name: "Developers",
              href: "/about/team#developers",
              description: "Our talented engineering team",
            },
            {
              name: "Designers",
              href: "/about/team#designers",
              description: "Creative minds behind our work",
            },
            {
              name: "Join Us",
              href: "/careers",
              description: "Open positions and culture",
            },
          ],
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              description: "Agile and collaborative approach",
            },
            {
              name: "Support",
              href: "/about/support",
              description: "Ongoing maintenance and help",
            },
          ],
        },
      ],
    ...
    portfolio: {
      ...
      sections: [
        {
          ...
          items: [
            ...
            {
              name: "Web Portals",
              href: "/portfolio/portals",
              description: "Custom portal solutions",
            },
          ],
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              description: "Community and networking apps",
            },
            {
              name: "Productivity Tools",
              href: "/portfolio/productivity",
              description: "Business efficiency applications",
            },
          ],
        },
        {
      ...
      featured: {
        ...
        description:
          "Real-time data visualization and machine learning insights",
      ...
      sections: [
        {
          ...
          items: [
            ...
            },
            {
              ...
              href: "/blog/mobile",
              description: "iOS and Android insights",
            },
            {
              name: "DevOps & Cloud",
              href: "/blog/devops",
            ...
            },
            {
              name: "Design & UX",
              href: "/blog/design",
              description: "User experience best practices",
            },
          ],
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              description: "Real project breakdowns",
            },
            {
              name: "Industry News",
              href: "/blog/news",
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              name: "Podcast",
              href: "/blog/podcast",
              description: "Tech talks and interviews",
            },
            {
              name: "Webinars",
              href: "/blog/webinars",
  ...
  if (variant === "dashboard") {
    return (
      <motion.header
        className="relative bg-white shadow-md border-b border-gray-200"
        ...
        <div className="relative px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-20">
            ...
            <nav className="hidden lg:flex items-center space-x-1">
              <Link
                href="/dashboard"
                className="group relative px-6 py-3 text-gray-900 hover:text-[#4689ec] font-medium transition-all duration-300 rounded-xl hover:bg-gray-50"
              >
              ...
              <Link
                ...
                className="group relative px-6 py-3 text-gray-700 hover:text-[#4689ec] font-medium transition-all duration-300 rounded-xl hover:bg-gray-50"
              >
                <span className="relative z-10 flex items-center">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Button
                variant="outline"
                size="sm"
                className="border-gray-300 text-gray-700 hover:bg-red-50 hover:border-red-400 hover:text-red-500 transition-all duration-300 rounded-xl px-4 py-2 font-medium"
              >
    ...
    >
      ...
      <div className="relative px-6 lg:px-8">
        <div className="flex justify-between items-center h-24">
          ...
          <nav
            className="hidden lg:flex items-center justify-center flex-1 space-x-2"
            ref={navRef}
          >
            {/* Services Dropdown */}
            <div
            ...
            <nav className="px-6 py-6 space-y-4">
              ...
              <div className="space-y-2">
                <button
                  onClick={() =>
                    setActiveDropdown(
                      activeDropdown === "about-mobile" ? null : "about-mobile"
                    )
                  }
                  className="w-full flex items-center justify-between px-4 py-3 text-gray-700 hover:text-[#4A90E2] hover:bg-[#4A90E2]/5 font-semibold rounded-xl transition-all duration-300 focus-ring"
              ...
              <div className="space-y-2">
                <button
                  onClick={() =>
                    setActiveDropdown(
                      activeDropdown === "blog-mobile" ? null : "blog-mobile"
                    )
                  }
                  className="w-full flex items-center justify-between px-4 py-3 text-gray-700 hover:text-[#4A90E2] hover:bg-[#4A90E2]/5 font-semibold rounded-xl transition-all duration-300 focus-ring"
      ...
      <AnimatePresence>
        {activeDropdown &&
          navigationData[activeDropdown as keyof typeof navigationData] && (
            <motion.div
            ...
            >
              <div className="max-w-7xl mx-auto px-6 lg:px-8 py-12">
                {(() => {
                  const dropdownData =
                    navigationData[
                      activeDropdown as keyof typeof navigationData
                    ];
                  return (
