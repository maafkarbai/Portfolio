            ...
            <form className="space-y-4" onSubmit={handleCredentialsSignIn}>
              <div>
                ...
                <input
                  ...
                  autoComplete="email"
                  required
                  className="appearance-none rounded-lg relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 focus:outline-none focus:ring-[#4689ec] focus:border-[#4689ec] focus:z-10 sm:text-sm"
              ...
              <div>
                ...
                <p className="mt-1 text-xs text-gray-500">
                  Enter any password for demo. User will be created automatically.
                </p>
              </div>
