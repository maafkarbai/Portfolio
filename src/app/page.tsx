          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
            ...
            <div className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-100">
              ...
              <p className="text-gray-600 mb-6">
                Built a complete e-commerce platform with custom inventory management, resulting in 40% increase in online sales and improved customer experience.
              </p>
              <div className="flex flex-wrap gap-2 mb-6">
                <span className="px-3 py-1 bg-[#4A90E2]/10 text-[#4A90E2] text-sm rounded-full font-medium">Next.js</span>
                <span className="px-3 py-1 bg-[#2EC4B6]/10 text-[#2EC4B6] text-sm rounded-full font-medium">PostgreSQL</span>
                <span className="px-3 py-1 bg-[#FF9505]/10 text-[#FF9505] text-sm rounded-full font-medium">Stripe</span>
              </div>
              <div className="border-t border-gray-100 pt-4">
                <p className="text-sm text-gray-500 mb-2">Results:</p>
                <p className="text-[#2EC4B6] font-semibold">+40% Sales Increase • +60% User Engagement</p>
              </div>
            </div>
            ...
            <div className="group bg-white rounded-2xl p-8 shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-100">
              ...
              <p className="text-gray-600 mb-6">
                Developed a comprehensive CRM system with automated workflows, reducing manual tasks by 50% and improving customer retention by 25%.
              </p>
              <div className="flex flex-wrap gap-2 mb-6">
                <span className="px-3 py-1 bg-[#4A90E2]/10 text-[#4A90E2] text-sm rounded-full font-medium">React</span>
                <span className="px-3 py-1 bg-[#2EC4B6]/10 text-[#2EC4B6] text-sm rounded-full font-medium">Node.js</span>
                <span className="px-3 py-1 bg-[#FF9505]/10 text-[#FF9505] text-sm rounded-full font-medium">MongoDB</span>
              </div>
              <div className="border-t border-gray-100 pt-4">
                <p className="text-sm text-gray-500 mb-2">Results:</p>
                <p className="text-[#2EC4B6] font-semibold">-50% Manual Tasks • +25% Customer Retention</p>
              </div>
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
              ...
              <p className="text-gray-600 mb-6 italic">
                "Techlogies transformed our online presence completely. The e-commerce platform they built increased our sales by 40% within the first quarter."
              </p>
              <div className="border-t border-gray-100 pt-4">
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
              ...
              <p className="text-gray-600 mb-6 italic">
                "The CRM system they developed streamlined our entire workflow. We've reduced manual tasks by 50% and our team is more productive than ever."
              </p>
              <div className="border-t border-gray-100 pt-4">
                <p className="font-semibold text-gray-900">Michael Chen</p>
                <p className="text-sm text-gray-500">Operations Manager, Tech Solutions Inc</p>
              </div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100">
              ...
              <p className="text-gray-600 mb-6 italic">
                "Professional, reliable, and results-driven. Techlogies delivered exactly what we needed, on time and within budget. Highly recommended!"
              </p>
              <div className="border-t border-gray-100 pt-4">
                <p className="font-semibold text-gray-900">Emily Rodriguez</p>
                <p className="text-sm text-gray-500">Founder, Digital Marketing Pro</p>
              </div>
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 items-center opacity-60">
              <div className="flex justify-center">
                <div className="w-24 h-12 bg-gray-200 rounded-lg flex items-center justify-center">
                  <span className="text-xs font-bold text-gray-400">CLIENT 1</span>
                </div>
              </div>
              <div className="flex justify-center">
                <div className="w-24 h-12 bg-gray-200 rounded-lg flex items-center justify-center">
                  <span className="text-xs font-bold text-gray-400">CLIENT 2</span>
                </div>
              </div>
              <div className="flex justify-center">
                <div className="w-24 h-12 bg-gray-200 rounded-lg flex items-center justify-center">
                  <span className="text-xs font-bold text-gray-400">CLIENT 3</span>
                </div>
              </div>
              <div className="flex justify-center">
                <div className="w-24 h-12 bg-gray-200 rounded-lg flex items-center justify-center">
                  <span className="text-xs font-bold text-gray-400">CLIENT 4</span>
                </div>
              </div>
              <div className="flex justify-center">
                <div className="w-24 h-12 bg-gray-200 rounded-lg flex items-center justify-center">
                  <span className="text-xs font-bold text-gray-400">CLIENT 5</span>
                </div>
              </div>
              <div className="flex justify-center">
                <div className="w-24 h-12 bg-gray-200 rounded-lg flex items-center justify-center">
                  <span className="text-xs font-bold text-gray-400">CLIENT 6</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:-translate-y-2">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Free Website Audit</h3>
              <p className="text-gray-600 mb-6">
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:-translate-y-2">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Website Launch Checklist</h3>
              <p className="text-gray-600 mb-6">
                A comprehensive checklist to ensure your website is ready for launch and optimized for success.
              </p>
              <Link href="/contact">
                <Button variant="outline" className="w-full border-[#2EC4B6] text-[#2EC4B6] hover:bg-[#2EC4B6] hover:text-white py-3 rounded-xl">
                  Download Free
                </Button>
              </Link>
            </div>
            ...
            <div className="bg-white rounded-3xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 hover:-translate-y-2">
              ...
              <h3 className="text-xl font-bold text-gray-900 mb-4">Website ROI Calculator</h3>
              <p className="text-gray-600 mb-6">
                Calculate the potential return on investment for your new website or e-commerce platform.
              </p>
              <Link href="/contact">
                <Button variant="outline" className="w-full border-[#FF9505] text-[#FF9505] hover:bg-[#FF9505] hover:text-white py-3 rounded-xl">
                  Use Calculator
                </Button>
              </Link>
            </div>
          ...
          <div className="text-center mt-12">
            <p className="text-gray-600 mb-6">Want more resources? Check out our blog for the latest insights.</p>
            <Link href="/blog">
              <Button variant="outline" className="border-[#4A90E2] text-[#4A90E2] hover:bg-[#4A90E2] hover:text-white px-8 py-3 rounded-xl font-semibold">
                Visit Our Blog
              </Button>
            </Link>
          </div>
